...
## Brandi (AI Agent)
Brandi is a scheduled Codex agent that scans Liz's Gmail for brand deal opportunities and creates/updates deals via the API. See `brandi/` folder for her instructions, personality, and feedback log. All her activity is tagged with `actor: 'brandi'` in deal_activities.
